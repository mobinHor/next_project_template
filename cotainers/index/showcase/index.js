...
const index = () => {
  return (
    <Grid className='p-4 bg-grey' container justifyContent="space-between" alignItems="center">
        <Grid item xs={6}>
            <div className={styles.showcase}>
                <h1 className='fs-md-2'>سود سرمایه گذاری را  <br /> شما تعیین کنید.</h1>
                <h2 className='fs-md-1 weight-400 color-semi-dark my-auto'>سرمایه گذاری در بازار سرمایه بدون نیاز به  <br/> صرف دانش و زمان</h2>
                <div className='d-flex'>
                    <CustomBtn style={{borderRadius:'6px'}} bgClass="primaryBordered" text="دریافت مشاوره رایگان"/>                
